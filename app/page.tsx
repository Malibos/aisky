...
export default function Page() {
  ...
  return (
    <main className="relative h-[100dvh] min-h-[100dvh] w-full overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 z-10 h-[25vh] w-full bg-gradient-to-t from-black from-70% to-transparent md:h-48 md:from-black md:from-0%" />
